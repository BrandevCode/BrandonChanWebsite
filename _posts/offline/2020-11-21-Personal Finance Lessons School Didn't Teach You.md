...
comment: 1
img: \images\posts\finance\10 Personal.png
...
<!-- 
"Does money equal happiness?". The answer is, it depends on the person. However, I will bet that the majority of people would not say having more money would make their life worse. Why is that? It is because having money helps everyone.

Learning how to properly manage our money can inform us to make the best decision when it comes to planning our financial goal. Money can allow us to be safe, to improve ourselves, give our family a better life, and to give back to our community. Overall money is important, it does not equal happiness but it can be used as a tool to give not only ourselves happiness, but those we have close relationships with. -->
...
## Investing
<!-- <img src="images/posts/finance/time-is-money-3.png" style="display:block; float: left; margin: 10px; width:25%"> -->
...
<!-- <ul class="collapsible post" data-collapsible="accordion">
<li>
<div class="collapsible-header post" markdown="1"><i class="las la-caret-down left rotate la-rotate-270"></i>
Compound Interest Calculator (show/hide)
</div>
<div class="collapsible-body post" markdown="1">

Starting Lump Sum Saving: ($) <input type="text" id="lump-sum" value="1000"/>

Monthly Savings: ($/month) <input type="text" id="monthly-saving" value="100"/>

Interest Rate (%): <input type="text" id="rate" value="5"/>

Years: <input type="text" id="years" value="5"/>
...
<div id="compound-calculator-chart" style="background: rgba(250, 250, 250, 0.9)"></div>

<table id="tabulated-data" style="width:80%">
    <thead>
        <tr>
            <th><b>Date</b></th>
            <th><b>Savings</b></th>
...
<!-- {% 
include link.html 
url="www.youtube.com/watch?v=D7c2hLdjK5g" 
title="Investing For Beginners In Canada (10 THINGS YOU NEED TO KNOW!!)"
description="📈📚 FREE Training Crash Course + Join Our Investing Academy ➤ https://bit.ly/theinvestingacademy Today we'll talk about 10 things you need to know when it com..." 
imageURL="https://i.ytimg.com/vi/D7c2hLdjK5g/maxresdefault.jpg" 
%} -->


<!-- {% 
include link.html 
url="www.youtube.com/watch?v=gtFR8E2hrPg" 
title="5 Investing Mistakes To Avoid In Your 20’s"
description="These are the 5 most common investing mistakes people make in their 20’s, and exactly how to avoid them. Enjoy! Add me on Instagram: GPStephan Merch: http://..." 
imageURL="https://i.ytimg.com/vi/gtFR8E2hrPg/maxresdefault.jpg" 
%}

### Summary Of 5 Investing Mistakes To Avoid In Your 20s

1. Not Investing Now
2. Copying Someone Elses Investment Strategy. (Your goals will be most likely be different than theirs)
3. Trying to time the market. The best strategy when it comes to doing this is simply buy, and hold. That’s it. The reality is that 99.99% of people won’t be able to time the market consistently and accurately. 
4. Getting Emotional 
5. Take advantage of TFSA and RRSP
-->
...
<!-- {% 
include link.html 
url="www.youtube.com/watch?v=Fj4anUL-LvY" 
title="Adam Ruins Everything - The Real Reason Taxes Suck (And Why They Don't Have To) | truTV"
description="Even Reagan and Obama would have agreed that filing your taxes should be easier...So why isn't it?" 
imageURL="https://i.ytimg.com/vi/Fj4anUL-LvY/maxresdefault.jpg" 
%} -->
